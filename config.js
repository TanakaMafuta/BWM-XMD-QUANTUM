...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Cyber Ghost",
    OWNER_NUMBER: process.env.OWNER_NUMBER || "263785061900",
    BOT: process.env.BOT_NAME || 'CYBER-GHOST',
    URL: process.env.BOT_MENU_LINKS || 'https://files.catbox.moe/u92uxh.jpg',
    BWM_XMD: hybridConfig.buildContentLayer(),
    GURL: 'https://whatsapp.com/channel/0029VbBoEYeGJP8FhBorEC2K',
    ...
    BOT_URL: process.env.BOT_URL ? process.env.BOT_URL.split(',') : [
        'https://files.catbox.moe/s0sc04.jpg',
    ...
    FOOTER: process.env.BOT_FOOTER || '\n\nFor more info call cyber-ghost: \n\n®2025 CYBER-GHOST 🔥',
    DATABASE_URL,
